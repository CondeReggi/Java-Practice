...
public class First {
	...
	static void calcularRaices(Double a, Double b, Double c) {
		...
		if ((Math.pow(b, 2) - 4 * a * c) >= 0) {
			...
			if ((-b + Math.sqrt(Math.pow(b, 2) - 4 * a * c)) / (2 * a) != (-b - Math.sqrt(Math.pow(b, 2) - 4 * a * c))
					/ (2 * a)) {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * System.out.println("La suma es: " + sumarNumeros( Integer.parseInt(num1) ,
		 * num2) ); System.out.println("entonces => " + mayorAB( Integer.parseInt(num1)
		 * , num2) );
		 */
		 ...
		 * System.out.println("El area del circulo de radio " + radio + " es: " +
		 * areaCirculo( Double.parseDouble(radio) ) );
		 */

		/*
		 * System.out.println("Ingrese dos numeros"); int a = sc.nextInt(); int b =
		 * sc.nextInt();
		 * 
		 ...
		 * int hasta;
		 * 
		 * do { hasta = sc.nextInt(); } while ( sumatoria( hasta ) == -1 );
		 * 
		...
		// System.out.println("Hola como estas".split("").length); // El string como
		// cadena de texto no se puede usar directamente length

		// System.out.println( "Hola".equals( "Holsa" ) ); // Con .equals puedo comparar
		// 2 cadenas
